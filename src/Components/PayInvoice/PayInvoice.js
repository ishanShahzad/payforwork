            ...
            <div className="row"> 
              <div className="col-lg-6 text-left">
                <div className="andot aos-init aos-animate" data-aos="flip-up" data-aos-delay="0" data-aos-duration="10">
                  ...
                  <p className="hw_para">Please verify all works done by the freelancer before you pay any invoice. Invoice for small jobs can be paid at once when the required work is finished. For larger jobs, you can agree with the freelancer for different milestone payments.</p> <h3 className="hw_subtitle">Leave feedback</h3> <p className="hw_para1">Post a job with all the details about the work gets done. This will be looking by the experts who registered with us and will give you competent offers.</p>
              </div> 
