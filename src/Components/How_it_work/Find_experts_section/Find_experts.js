            ...
            <div className="row">
                <div className="color_divs" >
                    ...
                    <div className="first">
                        ...
                        <img className="img2" src="images/one.png" data-aos="fade-left" data-aos-easing="ease-out-cubic" data-aos-duration="3000" alt=""/>
                  ...
                  <div className="line"></div>
                   ...
                   <button>POST A JOB</button>
                    ...
                    <div className="col-md-6 ">
                        ...
                        <img className="pic" src="images/one.png" data-aos="fade-left" data-aos-easing="ease-out-cubic" data-aos-duration="3000" alt=""/>
